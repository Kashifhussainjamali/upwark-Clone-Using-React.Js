...
const Section2=({count_1,count_2,hour,detail,spents,loca})=>{
    ...
    <hr />
        <small className={style["small"]}>Posted 4 hours ago</small>
        <ul className={style["ul1"]}>
            <li className={style["regarding"]}>Facebook Ads Pixel & Conversion APIs <br /> Setup for Shopify Store</li>
